/**
 * IGlue - Responsive Admin Theme
 * Copyright 2015 Bluntsoftware.com
 *
 */
    ...
    return {
        link: function(scope, element) {
            var listener = function(event, toState, toParams, fromState, fromParams) {
                ...
                var title = 'IGlue | Responsive Admin Theme';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle) title = 'IGlue | ' + toState.data.pageTitle;
                $timeout(function() {
                    element.text(title);
                });
            };
...
catwalkApp.directive('ngSimpleUpload', [function () {
    return {
        scope: {
            webApiUrl: '@',
            callbackFn: '=',
